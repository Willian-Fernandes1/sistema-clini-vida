...
1. Abrindo o MariaDB pelo Terminal cmd do windowns
...
________________________________________
3. Criando o Usuário do Sistema
...
________________________________________
5. Confirmando as Permissões
FLUSH PRIVILEGES;
Explicação:
•	Atualiza as permissões para que passem a valer imediatamente.
________________________________________
6. Verificando se o Banco Foi Criado
SHOW DATABASES;
Explicação:
...
2025-11-04 |
01:00:00.000000 |
paciente se queixando de dor no peito
...
________________________________________
✅ Pronto!
Agora o banco está criado, com usuário configurado e permissões aplicadas para uso pelo sistema.
...
Apague o banco clini_vida no MariaDB e rode o sistema novamente (o admin será recriado).
•	Porta 8080 ocupada:
Mude a porta no application.properties:
•	server.port=8081
•	Erro ao conectar no banco:
Verifique se o MariaDB está rodando e se o login/senha estão corretos.
________________________________________
👨‍💻 Autor
